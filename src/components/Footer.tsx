export default function Footer() {
  return (
    <footer className="w-full bg-[#2f2f2f] border-t border-[#3a3a3a] py-12 px-6 md:px-8">
      <div className="max-w-[1200px] mx-auto">
        ...
        <div className="border-t border-[#3a3a3a] mt-8 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-gray-500 text-xs">
            © 2026 Toko Menteng. Alle rechten voorbehouden.
          </p>
          <div className="flex gap-6">
            <a href="#" className="text-gray-500 text-xs hover:text-amber transition-colors">
              Privacybeleid
            </a>
            <a href="#" className="text-gray-500 text-xs hover:text-amber transition-colors">
