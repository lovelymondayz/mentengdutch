...
const menuData: Record<string, MenuItem[]> = {
  bowls: [
    ...
    {
      name: 'Nasi Goreng',
      description: 'Krokant gebakken rijst met groenten, ei en uw keuze van vlees of garnalen, met onze eigen bumbu.',
      price: '€14,50',
  ...
  signature: [
    ...
    {
      name: 'Saté Ayam / Babi',
      description: 'Pittige kip- of varkenssaté, gegrild met traditionele kruiden, geserveerd met pindasaus.',
      price: '€5,50',
      image: 'https://images.unsplash.com/photo-1529563021893-cc83c992d75d?w=400&q=80',
    },
    {
      name: 'Sambal Goreng Telor',
      description: 'Pittige gestoofde eieren in sambal, met knoflook, sjalot en limoenblad.',
      price: '€8,50',
      image: 'https://images.unsplash.com/photo-1565557623262-b51c2513a641?w=400&q=80',
    },
    {
      name: 'Sayur Lodeh',
      description: 'Romige stoofschotel met kool, boontjes, papaja en young jackfruit in kokosmelk.',
      price: '€12,00',
  ...
  desserts: [
    ...
    {
      name: 'Spekkoek',
      description: 'Traditioneel Indonesisch laagkoekje — gewürzig, boterig, en perfect met een kop thee.',
      price: '€3,50',
